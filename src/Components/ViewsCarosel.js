...
const ViewCarousel = () => {
  ...
  return (
    <Container className="p-0" fluid>
            ...
            <Navbar.Collapse className="justify-content-end">
              <Navbar.Text style={{ cursor: "pointer" }}>
                <img
                  ...
                  className="mt-1"
                  style={{ width: "54px", height: "46px", cursor: "pointer" }}
                  src={burgerMenu}
                ></img>
              </Navbar.Text>
            </Navbar.Collapse>
      ...
      <Drawer
        style={{ backgroundColor: "#101010" }}
        className="d-flex align-content-lg-center justify-content-center"
        anchor="top"
        open={openDrower}
      ...
      >
        <List>
          ...
          <a
            ...
            href="https://drive.google.com/file/d/1iHMtZywOUieSmcq8pCyhatoUfswhwnoS/view?usp=sharing"
            style={{ textDecoration: "none" }} // Optional: Prevent link underlining
          >
            <ListItemButton>
              <ListItemIcon>
                <img src={CV} alt="CV" />
          ...
          <ListItemButton
            target="_blank"
            rel="noopener noreferrer"
            href="https://www.instagram.com/kyaloo__/"
          >
            <ListItemIcon>
          ...
          <ListItemButton target="_blank" href="https://github.com/edwinkimani">
            <ListItemIcon>
          ...
          <ListItemButton
            target="_blank"
            href="https://www.linkedin.com/in/edwin-ngila?utm_source=share&utm_campaign=share_via&utm_content=profile&utm_medium=android_app/"
          >
            <ListItemIcon>
          ...
          <ListItemButton target="_blank" href="https://wa.me/+254704922743">
            <ListItemIcon>
